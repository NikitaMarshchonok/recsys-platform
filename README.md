...
- API tests: 11 passing tests for root, health, version, readiness, tracing, stats, valid recommendations, OpenAPI schemas, OpenAPI examples, invalid users, and request validation
